...
# Install python3 if missing (needed by XC-VM installer)
...
# Download latest XC-VM release zip
...
# The zip may extract into a subdirectory — find the install script
...
# Copy our non-interactive patch driver
...
# XC-VM installs itself to /home/xc_vm and manages its own nginx on $XCVM_PORT
# Read the actual admin access code generated by the installer
