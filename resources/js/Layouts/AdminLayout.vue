...
const navItems = [
  ...
  { href: '/admin/vod', label: 'VOD', permissions: 'vod_management', icon: icon('M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z') },
...
const managementItems = [
  ...
  { href: '/admin/channels/push', label: 'Stream Push', icon: icon('M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4') },
]
