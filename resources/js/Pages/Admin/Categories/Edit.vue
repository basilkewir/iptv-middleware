<template>
  <AdminLayout>
    <div class="p-6 max-w-3xl mx-auto">
      ...
      <form @submit.prevent="form.put(route('admin.categories.update', category.id))" class="space-y-6">
        <div class="card">
...
const form = useForm({
  ...
  banner_image: props.category.banner_image || '',
  color: props.category.color || '',
  parent_id: props.category.parent_id,
  sort_order: props.category.sort_order,
  is_active: props.category.is_active,
  category_type: props.category.category_type,
  auto_assign_channels: props.category.auto_assign_channels,
  auto_assign_vod: props.category.auto_assign_vod,
  include_in_m3u: props.category.include_in_m3u,
  include_in_xmltv: props.category.include_in_xmltv,
})
</script>
