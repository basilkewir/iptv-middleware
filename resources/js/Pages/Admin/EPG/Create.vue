  ...
  <AdminLayout>
    <div class="p-6 max-w-4xl mx-auto">
      <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-white">Add EPG Source</h1>
      </div>

      <form @submit.prevent="form.post(route('admin.epg.store'))" class="space-y-6">
        <!-- Source Details -->
        <div class="card">
          ...
          <div class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <input v-model="form.name" type="text" class="input-field" placeholder="My EPG Source" />
              ...
              <div>
                ...
                <input v-model="form.url" type="url" class="input-field" placeholder="http://example.com/epg.xml" />
        ...
        <div class="flex justify-end gap-3">
          ...
          <button type="submit" :disabled="form.processing" class="btn-primary">
            {{ form.processing ? 'Adding...' : 'Add EPG Source' }}
          </button>
        </div>
      </form>
    </div>
...
const form = useForm({
  ...
  is_active: true,
  auto_mapping: false,
  mapping_strategy: 'name',
  channel_mappings: [{ channel_id: '', epg_channel_id: '', epg_channel_name: '' }],
})
