<template>
  <AppLayout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <div class="mb-6">
        <Link :href="route('client.channels.show', channel.id)" class="text-gray-400 hover:text-white text-sm flex items-center gap-1 mb-2">
      ...
      <form @submit.prevent="form.post(route('client.channels.update', channel.id))" class="space-y-6">
        <!-- Basic Information -->
        ...
        <div class="flex items-center gap-4">
          ...
          <Link :href="route('client.channels.show', channel.id)"
...
const form = useForm({
  ...
  channel_number: props.channel.channel_number,
  logo_url: props.channel.logo_url,
  banner_url: props.channel.banner_url,
  background_color: props.channel.background_color,
  accent_color: props.channel.accent_color,
  text_color: props.channel.text_color,
  stream_url: props.channel.stream_url,
  stream_type: props.channel.stream_type,
  stream_key: props.channel.stream_key,
  output_resolution: props.channel.output_resolution,
  output_bitrate: props.channel.output_bitrate,
  playlist_mode: props.channel.playlist_mode,
  default_duration: props.channel.default_duration,
  loop_playlist: props.channel.loop_playlist,
  shuffle_mode: props.channel.shuffle_mode,
  is_live: props.channel.is_live,
  broadcast_status: props.channel.broadcast_status,
  scheduled_start: props.channel.scheduled_start,
  scheduled_end: props.channel.scheduled_end,
  timezone: props.channel.timezone,
  enable_ticker: props.channel.enable_ticker,
  ticker_text: props.channel.ticker_text,
  ticker_speed: props.channel.ticker_speed,
  ticker_color: props.channel.ticker_color,
  ticker_background: props.channel.ticker_background,
  enable_overlay_logo: props.channel.enable_overlay_logo,
  overlay_logo_position: props.channel.overlay_logo_position,
  overlay_logo_size: props.channel.overlay_logo_size,
  language: props.channel.language,
  genre: props.channel.genre,
  category: props.channel.category,
  is_adult: props.channel.is_adult,
  is_featured: props.channel.is_featured,
  is_active: props.channel.is_active,
  is_public: props.channel.is_public,
})
</script>